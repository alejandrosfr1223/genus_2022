            ...
            <div id="loginbuttons">
                @auth
                    ...
                    <div class="col-lg-6 col-md-12 mb-4 mb-md-0" id="but_div">
                        <a class="loginbtns" id="myaccount" name="myaccount"  href="/genus/user/profile">{{ trans("mainlayout.myaccount") }}</a>
            ...
            <center>
              <a href="{{route('home')}}" style="text-decoration: none;">
                <table style="margin-top:20px;">
                    <tr>
                        <td>
                            <img class="" src="{{ asset('/img/logos/genus.png') }}" style="width: 11rem; margin: auto;">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <h1 style="margin: auto; color: black; font-size: 3.5rem;">Genus</h1>
                        </td>
                    </tr>
                </table>
              </a>
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
              <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="margin: auto;">
                ...
                <li class="nav-item right-border">
                  <a class="nav-link {{ request()->routeIs('nous.*') ? 'active' : '' }}" href="{{route('nous.home')}}">Nous</a>
                </li>
                <li class="nav-item right-border">
                  <a class="nav-link {{ request()->routeIs('dendro.*') ? 'active' : '' }}" href="{{route('dendro.home')}}">Dendro</a>
                </li>
                @auth
                    @if (Auth::user()->roles->first() == [])
                    <li class="nav-item">
                      <a class="nav-link {{ request()->routeIs('genea.*') ? 'active' : '' }}" href="{{route('genea.home')}}">Genea</a>
                    </li>
                    @else
                        @if (Auth::user()->roles->first()->name == "Administrador" || Auth::user()->roles->first()->name == "Operador")
                            ...
                            <li class="nav-item">
                              <a class="nav-link {{ request()->routeIs('dashboard') ? 'active' : '' }}" href="/genus/admin">{{ trans("mainlayout.dashboard") }}</a>
                            </li>
                        @else
                            <li class="nav-item">
                              <a class="nav-link {{ request()->routeIs('genea.*') ? 'active' : '' }}" href="{{route('genea.home')}}">Genea</a>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-12 mb-4 mb-md-0">
            <table id="footerlogo">
                <tr>
                    <td>
                        <img class="footer_img" src="{{ asset('/img/logos/genus.png') }}">
                    </td>
                    <td>
                        <h1 class="footer_key">Genus</h1>
                    </td>
                </tr>
            </table>
            <br>
            <p style="color: black; font-size: 1.2rem; display: inline-block;">
              @choice('mainlayout.phonenumbers', 2):
            </p>
            <p class="centeremojistext" style="color: black; font-size: 1.2rem; display: flex; margin:10px 0;">
            ...
            <p class="centeremojistext" style="color: black; font-size: 1.2rem; display: flex; margin:10px 0;">
              {!! Emoji::toImage(':email:') !!} genus@sefaruniversal.com
            </p>
            ...
            <p style="color: black; font-size: 1.2rem; display: inline-block;">
              ...
              <a href="#" style="margin-top: 10rem; color: black !important; text-decoration: underline;">Conoce más</a>
            </p>
          </div>

          <div class="col-lg-6 col-md-12 mb-4 mb-md-0">
            <p style="color: black !important; font-size: 1.2rem;">
